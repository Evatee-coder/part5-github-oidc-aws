...
## Some of the below details will be used in backend.yaml
# servicename: devopsdojo-db-service
# namespace: devopsdojo
# dns name: ServiceName.Namespace.svc.cluster.local
# full dns: devopsdojo-db-service.devopsdojo.svc.cluster.local
