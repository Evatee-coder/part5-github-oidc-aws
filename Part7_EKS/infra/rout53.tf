...
# create/import the public hosted zone for your domain in route53 and update nameservers in your domain registrar
...
# create a route for subdomain -> ALB (after ingress is created in k8s)
resource "aws_route53_record" "app" {
  ...
  alias {
    ...
    zone_id                = "Z35SXDOTRQ7X7K" # us-east-1 ALB zone ID ---- #"ZP97RAFLXTNZK"  # ap-south-1 ALB zone ID
